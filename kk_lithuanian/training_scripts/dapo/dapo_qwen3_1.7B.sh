#!/usr/bin/env bash
# DAPO | text | vLLM rollout | FSDP training | 1x NVIDIA RTX A6000 48GB GPU
...
project_name=${PROJECT_NAME:-verl_dapo_qwen3_1.7B}
experiment_name=${EXPERIMENT_NAME:-qwen3_1.7B_dapo_$(date +%Y%m%d_%H%M)}
# ---- end user-adjustable ----
