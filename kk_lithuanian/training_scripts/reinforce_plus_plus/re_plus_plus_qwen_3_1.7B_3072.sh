#!/usr/bin/env bash
# REINFORCE++ | text | vLLM rollout | FSDP training | 1x NVIDIA RTX A6000 48GB GPU
...
project_name=${PROJECT_NAME:-verl_reinforce_plus_plus_qwen3_1.7B}
experiment_name=${EXPERIMENT_NAME:-qwen3_1.7B_re_plus_plus_$(date +%Y%m%d_%H%M)}
# ---- end user-adjustable ----
